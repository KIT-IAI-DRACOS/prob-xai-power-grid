...
for area in areas:
    ...
    for target in targets:
        ...
        filtered_params = {
            k: v for k, v in std_model.get_params().items() if k in search_space
        }
        ...
        best_model.fit(X_train.values, y_train.values.reshape(-1, 1),
                    max_epochs=100,
                    patience=50,
